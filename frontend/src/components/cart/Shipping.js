...
export const ValidateShipping = (shippingInfo,navigate) => {
    ...
    if (!shippingInfo.address ||
        ...
        !shippingInfo.posetelCode) { toast.error('Fill the Shipping information.'); navigate('/shipping')}
}
...
export default function Shipping() {
    ...
    const submitHandler = (e) => {
        e.preventDefault();
        dispatch(saveShippingInfo({ address, city, state, country, phoneNumber, posetelCode }));
        navigate('/order/confirm');
    }

    return shippingInfo?<Fragment>
        <CheckOutInfo step1 />
                    ...
                    <form id="addressForm" onSubmit={submitHandler}>
                        ...
                        <div className="mb-3">
                            ...
                            <textarea
                                ...
                                placeholder="Street address, building, suite..." required
                            ></textarea>
                        </div>
